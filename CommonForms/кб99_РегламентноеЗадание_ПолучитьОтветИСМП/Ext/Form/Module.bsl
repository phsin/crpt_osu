...
Процедура ПриОткрытии(Отказ)
	...
	Если Действие = "Добавить" Тогда
		...
		ИмяМетаданных = "кб99_РегламентноеЗадание_ПолучитьОтветИСМП";
		СинонимМетаданных = "кб99 Получить ответ ИСМП";
		ИмяМетодаМетаданных = "кб99_РегламентныеЗадания.кб99_РегламентноеЗадание_ПолучитьОтветИСМП";
		Наименование = "кб99 получить ответ ИСМП";
	КонецЕсли;
...
Процедура ЗаписатьРегламентноеЗадание()
	...
	Оповестить("Запись_ПолучитьОтветИСМП", Результат);
